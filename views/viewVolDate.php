      ...
      <?php while($volt=$vol->fetch_object()){
		  ...
		  $aero2f=$aero2->fetch_object();
		   ...
		   $compa=$com->fetch_object();
			echo'<a href="#reserv'.$compa->id_Comp.'" title="Cliquez pour Reserver" data-toggle="modal"><div class="col-sm-3"><div class="panel panel-default"><div class="panel-heading">
	   ...
	   ?>
	   <div class="modal fade" id="reserv<?php echo$compa->id_Comp;?>" style="font_family:'NewTime Romani';">
