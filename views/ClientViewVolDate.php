...
<?php $connect=new mysqli('localhost','root','','flightmanagement');
	  ...
	  $getVol="SELECT*FROM Vol WHERE DateDep ='".$this->session->flashdata('tab1')."' AND StatusVol='Autorise' ORDER BY HeureDep;";
...
<div class="container">
	  ...
	  <hr/>
	 <center><div id="baniere" ><center><h3 style="color: white; font-family:Century Gothic;">Voici La liste des Vols du&nbsp;<i style="color: cyan;"><?php echo $this ->session ->flashdata('tab');?></i></h3><center></div></center>
	  <hr/>
	  <div class="row">
	   ...
	   <div class="modal fade" id="reserv<?php echo $volt->idVol;?>" style="font_family:'NewTime Romani';">
			...
			<div class="modal-content">
				...
				<div class="col-md-offset-2 col-md-8">
                    <Center>     
					<h4>Cliquer pour réserver ou annulez</h4>
					<hr/>
					</Center>
