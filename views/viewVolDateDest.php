...
<div class="container">
	  ...
	  <hr/>
	 <div class="alert alert-danger text-center" ><h3 style="color: blue; font-family:Century Gothic;">Ligne&nbsp;<?php echo $aero1f->Localisation." > ".$aero2f->Localisation;?>&nbsp;|Vols du &nbsp;<i style="color: black;"><?php echo $this ->session ->flashdata('tab');?></i></h3></div>
	  <hr/>
	  <div class="row">
