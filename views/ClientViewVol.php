...
<?php $connect=new mysqli('localhost','root','','flightmanagement');
	  $getVol="SELECT*FROM Vol WHERE DateDep >'".date('Y-m-d')."' AND StatusVol='Autorise' ORDER BY DateDep;";
...
<center><div id="baniere" ><center><h3 style="color:white;font-family:Century Gothic;">Les programmes des Vols Disponibles sur le site</h3></center></div></center>
<hr/>
       <div class="row">
	   <?php while($volt=$vol->fetch_object()){
		   ...
		   $compa=$com->fetch_object();
			echo'<a href="#reserv'.$volt->idVol.'" title="Cliquez pour Reserver" data-toggle="modal"><div class="col-sm-3"><div class="panel panel-success"><div class="panel-heading">
				<h4 class="panel-title">'.$compa->NomComp.'</h4>
				</div><div class="panel-body"><p><ul class="list list-unstyled" style="color:purple;"><li>Date de Depart : '.$volt->DateDep.'</li><li>Date d\'arrivée : '.$volt->DateArrivee.'</li><li>Heure du Vol : '.$volt->HeureDep.'</li><li>Heure d\'arrivée : '.$volt->HeureArr.'</li><li style="color:green;">Prix : <i style="color:lime">A partir de </i> '.$volt->PrixBillet.' $</li><li>Appareil : '.$avionyetu->typeAv.'</li><li>Quitte : '.$aero1f->Localisation.'</li><li>Destination : '.$aero2f->Localisation.'</li><li>Escales : '.$volt->Escales.'</li><li style="color:red;">Places disponibles : '.$volt->NbrPlaces.'</li></ul></p></div><div class="panel-footer">Nom Avion : '.$avionyetu->NomAv.'</div></div></div></a>';
...
<div class="modal fade" id="Connect" style="font_family:'NewTime Romani';">
		...
		<div class="modal fade" id="Inscription" style="font_family:'NewTime Romani';">
			...
			<div class="modal-content">
				<div class="modal-header" style="background-color: rgb(191,161,69);">
					<button class="close" data-dismiss="modal">x</button>
					<h3 class="modal-title" style="text-align:center; font_family:NewTime Romani; color:black">INSCRIPTION</h3>
				</div>
				...
				<div class="col-md-offset-2 col-md-8">
				   ...
				   <Center> 
						...
						<br>
						<select name="Sexe" class="form-control"><option value="M" >Votre Sexe</option><option value="M">Homme</option><option value="F">Fémin</option><select>
						<br>
						<br>
						<input type="text" class="form-control" placeholder="Date de Naissance" name="DateNaissance" required />
						<br>
						<input type="text" class="form-control" placeholder="Numéro de Téléphone" name="Telephone" required />
						<br>
						<input type="text" class="form-control" placeholder="Email" name="Email" required />
                        <br>                     
                        <input type="password" class="form-control" placeholder="Mot de Passe" name="Password" required />
						<br>
						<input type="password" class="form-control" placeholder="Confirmer mot de passe" name="Password1" required />
						<br>
						<input type="text" class="form-control" placeholder="Numero de Carte d'identité" name="NumeroPieceIdentite" required />
						<br>
                        ...
                        <button type="submit" class="btn btn-default" name="userSubmit" value=""><i class="fa fa-key"></i>  &nbsp; S'inscrire</button>
						<br>
						<br>
						<?php echo form_close();?>
						<span style="color:black; font_family:NewTime Romani;">Copyright &copy 2017-RVA/Bukavu.</span>
	...
	<div class="modal fade" id="About" style="font_family:'NewTime Romani';">
			...
			<div class="modal-content">
				...
				<center>
				<a href="<?php echo base_url('attachements/guide.pdf')?>" data-toggle="modal"><button class="btn btn-primary"><i class="fa fa-book">&nbsp;</i>Aide</button></a>
