...
<div class="col-sm-8 wowload fadeInRight panel panel-green" style="overflow-y:auto;height:450px;">
         <div class="panel-heading">
                       <span class="badge"><i class="fa fa-plane fa-fw"></i>Cliquez pour Afficher Les Reservations<span style="float:right;"></span>
                 </div>
                        <!-- .panel-heading -->
	...
	<?php
		...
		<?php echo form_open('reservation/getReservation')?>
	...
	<!-- Début Opérations sur réservations -->
			
		
		
			<!-- Fin Opérations sur les réservations -->
