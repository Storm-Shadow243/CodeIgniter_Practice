...
elseif($reserv->StatusReservation=="C"){ echo '<td>
'.form_open('gestion/printBill2').'<input type="hidden" name="res" value='.$reserv->idReservation.'>
<input type="hidden" name="vol" value="'.$reserv->idVol.'">
<input type="hidden" name="avion" value="'.$avion->NomAv.'">
<input type="hidden" name="immat" value="'.$avion->Immat.'">
<input type="hidden" name="type" value="'.$avion->typeAv.'">
<input type="hidden" name="comp" value="'.$comp->NomComp.'">
<input type="hidden" name="compC" value="'.$comp->CodeIATA.'">
<input type="hidden" name="aero" value="'.$aeroport->NomAeroport.'"> 
<input type="hidden" name="code" value="'.$aeroport->CodeOACI.'"> 
<input type="hidden" name="loc" value="'.$aeroport->Localisation.'"> 
<input type="hidden" name="aero2" value="'.$aeroport2->NomAeroport.'"> 
<input type="hidden" name="code2" value="'.$aeroport2->CodeOACI.'"> 
<input type="hidden" name="loc2" value="'.$aeroport2->Localisation.'"> 
<input type="hidden" name="logo" value="'.$comp->Logo.'">
<input type="hidden" name="place" value="'.$reserv->NbrPlaces.'">
<input type="hidden" name="prix" value="'.$vol->PrixBillet.'">
<button target="_blank" class="btn" type="submit" style="color:blue;" title="Voir et imprimer Billet"><i class="fa fa-print">&nbsp</i>Confirmé - Cliquez ici</i></button>'.form_close().'</td>';} ?></tr>
...
<div class="modal fade " id="<?php echo "Ops".$reserv->idReservation;?>" style="top:25px; " tabindex="-2" role="dialog" aria-labelledby="#Agent" aria-hidden="false">  
											...
											<h4 class="modal-title" id="depart" style="text-align:center"><i class="fa fa-user"></i>&nbsp;Opérations Réservation&nbsp;<?php echo $reserv->idVol;?></h4>
											<br>
											<center>
											<label>
											<?php echo form_open_multipart('reservation/cancelRes',array('method'=>'post'));?>
											Cliquer pour continuer, <i class="fa fa-eye">&nbsp;</i>soyez vigilant.  
											</label>
											<br>
											...
											<br>
											Au moindre Click vous pouvez supprimer votre réservation du système
											</center>
											...
											<div class="form-group">
											<center>
											<button type="submit" class="btn btn-danger"><span class="fa fa-edit"></span>   Annuler Réservation</button>
											<?php echo form_close();?>
