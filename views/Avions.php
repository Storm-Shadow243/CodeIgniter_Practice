...
<center>
<h3 style="font-family:Comic Sans Ms;color:black;"><i class="fa fa-upload">&nbsp;</i>Espace de télechargement de Photos</h3>
</center>
	<br>
	<br>
	...
	<?php
		while($avion=$wefound->fetch_object()){
			?>
		<tr><td style="color:blue;"><?php echo $avion->Immat;?></td><td><?php echo $avion->NomAv;?></td><td><?php echo $avion->typeAv;?></td>
			
		<td><a title="Ajouter Une Photo" style="color:red;" data-toggle="modal" href="#setEtat<?php echo $avion->idAvion;?>"><i class="fa fa-upload">&nbsp;&nbsp;<i style="color:blue; font-family:Century Gothic;">Télécharger une Photo</i></i></a></td></tr>
	...
	<h4 class="modal-title" id="depart" style="text-align:center"><i class="fa fa-plane"></i>&nbsp;Télécharger une image pour &nbsp;<?php echo $avion->NomAv;?></h4>
	<br>
	<center>
	<?php echo form_open_multipart('avion/upload',array('method'=>'post'));?>
	Nouvelle Photo de&nbsp;<?php echo$avion->NomAv;?>   
	<br>
	<br>
	<input type="hidden" value="<?php echo $avion->idAvion;?>" name="id" />
	<input type="text" class="form-control" placeholder="Nom Image | Exemple : Business Class" name="nom"/><br>
...
<center>	<a href="<?php echo site_url('gestion/FetchAvions');?>" class="btn btn-primary"><i class="fa fa-camera">&nbsp;</i>Afficher Les Images de nos avions!</a></center> 
</div>
</div>
