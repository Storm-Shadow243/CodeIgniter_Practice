...
<div class="container">
	  ...
	  <hr/>
	 <center><div id="baniere" ><center><h2 style="color: white; font-family:Century Gothic;">Voici La liste des Vols pouvant attérir à&nbsp;<i style="color: lime;"><?php echo $aero1f->Localisation." dans l'".$aero1f->NomAeroport;?></i></h2></center></div></center>
	  <hr/>
	  <div class="row">
